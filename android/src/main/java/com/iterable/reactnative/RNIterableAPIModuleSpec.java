...
@ReactModule(name = RNIterableAPIModuleSpec.NAME)
public abstract class RNIterableAPIModuleSpec extends ReactContextBaseJavaModule implements TurboModule {
    public static final String NAME = "RNIterableAPI";

    public RNIterableAPIModuleSpec(ReactApplicationContext reactContext) {
        super(reactContext);
    }
    ...
    @ReactMethod
    public abstract void setInAppShowResponse(double inAppShowResponse);
