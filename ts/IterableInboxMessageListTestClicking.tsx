...
import IterableInboxMessageCellTestClicking from './IterableInboxMessageCellTestClicking'
...
const IterableInboxMessageListTestClicking = ({
   dataModel,
   rowViewModels,
   customizations,
   ...
   function renderRowViewModel(rowViewModel: InboxRowViewModel, index: number, last: boolean) {
      return (
         <IterableInboxMessageCellTestClicking
...
export default IterableInboxMessageListTestClicking