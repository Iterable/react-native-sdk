...
class IterableInAppManager {
  ...
  async getMessages (): Promise<IterableInAppMessage[]> {
  ...
  async getInboxMessages (): Promise<IterableInAppMessage[]> {
  ...
  async showMessage (message: IterableInAppMessage, consume: boolean): Promise<string | undefined> {
  ...
  async getHtmlContentForMessage (message: IterableInAppMessage): Promise<IterableHtmlInAppContent> {
