...
@objc public class ReactIterableAPI: RCTEventEmitter {
    ...
    public func initializeWithApiKey(apiKey: String,
    ...
    public func initialize2WithApiKey(apiKey: String,
                     config configDict: NSDictionary,
                     version: String,
    ...
    public func setAttributionInfo(attributionInfo dict: NSDictionary?) {
        ...
        IterableAPI.attributionInfo = SerializationUtil.dictionaryToDecodable(dict: dict as! [AnyHashable: Any])
    }

    @objc(trackPushOpenWithCampaignId:templateId:messageId:appAlreadyRunning:dataFields:)
    public func trackPushOpenWithCampaignId(campaignId: NSNumber,
                       templateId: NSNumber?,
                       messageId: String,
    ...
    public func trackInAppOpen(messageId: String,
    ...
    public func trackInAppClick(messageId: String,
                         location locationNumber: NSNumber,
                         clickedUrl: String) {
        ITBInfo()
    ...
    public func trackInAppClose(messageId: String,
                         location locationNumber: NSNumber,
    ...
    public func inAppConsume(messageId: String,
                      location locationNumber: NSNumber,
                      source sourceNumber: NSNumber) {
        ITBInfo()
    ...
    public func getHtmlInAppContent(messageId: String, resolver: RCTPromiseResolveBlock, rejecter: RCTPromiseRejectBlock) {
        ITBInfo()
    ...
    public func handleAppLink(appLink: String, resolver: RCTPromiseResolveBlock, rejecter: RCTPromiseRejectBlock) {
        ITBInfo()
    ...
    public func getUnreadInboxMessagesCount(resolver: RCTPromiseResolveBlock, rejecter: RCTPromiseRejectBlock) {
        ITBInfo()
    ...
    public func showMessage(messageId: String, consume: Bool, resolver: @escaping RCTPromiseResolveBlock, rejecter: RCTPromiseRejectBlock) {
        ITBInfo()
    ...
    public func removeMessage(messageId: String, location locationNumber: NSNumber, source sourceNumber: NSNumber) {
        ITBInfo()
    ...
    public func updateSubscriptions(emailListIds: [NSNumber]?,
    ...
    @objc func initialize(withApiKey apiKey: String,
                            config configDict: NSDictionary,
                            version: String,
    ...
    public func receivedIterableInboxChanged() {
        ...
        delegate?.sendEvent(withName: EventName.receivedIterableInboxChanged.rawValue, body: nil as Any?)
    }
...
extension ReactIterableAPI: IterableAuthDelegate {
    public func onAuthTokenRequested(completion: @escaping AuthTokenRetrievalHandler) {
        ...
        DispatchQueue.global(qos: .userInitiated).async {
            self.delegate?.sendEvent(withName: EventName.handleAuthCalled.rawValue,
                           body: nil as Any?)
            ...
            if authTokenRetrievalResult == .success {
                ...
                self.delegate?.sendEvent(withName: EventName.handleAuthSuccessCalled.rawValue,
                               body: nil as Any?)
            } else {
                ...
                self.delegate?.sendEvent(withName: EventName.handleAuthFailureCalled.rawValue,
                               body: nil as Any?)
            }
        }
    }
