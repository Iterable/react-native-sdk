...
public class ReactIterableAPI: RCTEventEmitter {
    ...
    public func initialize2(apiKey: String,
                     config configDict: NSDictionary,
                     version: String,
    ...
    public func set(email: String?, authToken: String?) {
        ITBInfo()
    ...
    public func set(userId: String?, authToken: String?) {
        ITBInfo()
    ...
    public func set(attributionInfo dict: NSDictionary?) {
        ITBInfo()
    ...
    public func trackPushOpen(campaignId: NSNumber,
                       templateId: NSNumber?,
                       messageId: String,
    ...
    public func handle(appLink: String, resolver: RCTPromiseResolveBlock, rejecter: RCTPromiseRejectBlock) {
        ITBInfo()
    ...
    public func show(messageId: String, consume: Bool, resolver: @escaping RCTPromiseResolveBlock, rejecter: RCTPromiseRejectBlock) {
        ITBInfo()
    ...
    public func remove(messageId: String, location locationNumber: NSNumber, source sourceNumber: NSNumber) {
        ITBInfo()
    ...
    public func setRead(for messageId: String, read: Bool) {
        ITBInfo()
    ...
    public func set(autoDisplayPaused: Bool) {
        ITBInfo()
    ...
    public func passAlong(authToken: String?) {
        ITBInfo()
