...
describe('useAppStateListener', () => {
  ...
  test('should return initial app state', () => {
  ...
  test('should update state when app state changes to background', () => {
    // GIVEN the hook is rendered
    const { result } = renderHook(() => useAppStateListener());
  ...
  test('should update state when app state changes to inactive', () => {
    // GIVEN the hook is rendered
    const { result } = renderHook(() => useAppStateListener());
  ...
  test('should update state when app state changes back to active', () => {
  ...
  test('should handle initial state with different AppState.currentState', () => {
  ...
  test('should handle initial state with inactive AppState.currentState', () => {
  ...
  test('should not call addEventListener multiple times on re-renders', () => {
    // GIVEN the hook is rendered
