...
describe('useDeviceOrientation', () => {
  ...
  describe('initial state', () => {
    test('should return portrait orientation for portrait screen dimensions', () => {
    ...
    test('should return landscape orientation for landscape screen dimensions', () => {
    ...
    test('should return portrait orientation for square screen dimensions', () => {
    ...
    test('should handle edge case where height is slightly larger than width', () => {
  ...
  describe('orientation changes', () => {
    test('should update orientation when screen rotates from portrait to landscape', () => {
    ...
    test('should update orientation when screen rotates from landscape to portrait', () => {
    ...
    test('should handle multiple orientation changes', () => {
      // GIVEN initial portrait dimensions
      useWindowDimensionsSpy.mockReturnValue({
        height: 800,
        width: 400,
  ...
  describe('hook behavior', () => {
    test('should maintain consistent state across re-renders with same dimensions', () => {
    ...
    test('should return new object reference when dimensions change', () => {
    ...
    test('should handle rapid dimension changes', () => {
      // GIVEN initial dimensions
      useWindowDimensionsSpy.mockReturnValue({
        height: 800,
        width: 400,
  ...
  describe('type safety', () => {
    test('should return correct IterableDeviceOrientation interface', () => {
